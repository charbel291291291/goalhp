...
-- Safe to run multiple times (WHERE NOT EXISTS checks)
-- =====================================================================

-- TEAMS
INSERT INTO teams (name_en, name_ar, flag_emoji, fifa_code, group_name, primary_color, secondary_color)
SELECT v.name_en, v.name_ar, v.flag_emoji, v.fifa_code, v.group_name, v.primary_color, v.secondary_color
FROM (VALUES
  ...
  ('Turkiye',                'تركيا',                '🇹🇷', 'TUR', 'D', '#E30A17', '#FFFFFF'),
  ('Germany',                'ألمانيا',              '🇩🇪', 'GER', 'E', '#000000', '#DD0000'),
  ('Curacao',                'كوراساو',              '🇨🇼', 'CUW', 'E', '#003893', '#FED141'),
  ('Cote d Ivoire',          'ساحل العاج',           '🇨🇮', 'CIV', 'E', '#F77F00', '#009E60'),
...
) AS v(name_en, name_ar, flag_emoji, fifa_code, group_name, primary_color, secondary_color)
WHERE NOT EXISTS (SELECT 1 FROM teams WHERE fifa_code = v.fifa_code);

-- MATCHES
INSERT INTO matches (match_number, stage, group_name, team_a_id, team_b_id, kickoff_at, venue)
SELECT
  m.mn, m.stage, m.grp,
  (SELECT id FROM teams WHERE fifa_code = m.ta),
  (SELECT id FROM teams WHERE fifa_code = m.tb),
  m.ko::TIMESTAMPTZ,
  m.venue
FROM (VALUES
  -- Group A
  ...
  -- Group B
  (7,  'group','B','CAN','BIH','2026-06-12T19:00:00+03:00','Estadio Azteca'),
  (8,  'group','B','QAT','SUI','2026-06-13T16:00:00+03:00','MetLife Stadium'),
  (9,  'group','B','CAN','QAT','2026-06-16T19:00:00+03:00','BC Place'),
  (10, 'group','B','BIH','SUI','2026-06-17T16:00:00+03:00','Estadio Azteca'),
  (11, 'group','B','CAN','SUI','2026-06-20T19:00:00+03:00','Rose Bowl'),
  (12, 'group','B','BIH','QAT','2026-06-21T16:00:00+03:00','Mercedes-Benz Stadium'),
  -- Group C
  (13, 'group','C','BRA','MAR','2026-06-13T19:00:00+03:00','Estadio Azteca'),
  (14, 'group','C','HAI','SCO','2026-06-14T16:00:00+03:00','MetLife Stadium'),
  (15, 'group','C','BRA','HAI','2026-06-17T19:00:00+03:00','BC Place'),
  (16, 'group','C','MAR','SCO','2026-06-18T16:00:00+03:00','Estadio Azteca'),
  (17, 'group','C','BRA','SCO','2026-06-21T19:00:00+03:00','Rose Bowl'),
  (18, 'group','C','MAR','HAI','2026-06-22T16:00:00+03:00','Mercedes-Benz Stadium'),
  -- Group D
  (19, 'group','D','USA','PAR','2026-06-14T19:00:00+03:00','Estadio Azteca'),
  (20, 'group','D','AUS','TUR','2026-06-15T19:00:00+03:00','MetLife Stadium'),
  (21, 'group','D','USA','AUS','2026-06-18T19:00:00+03:00','BC Place'),
  (22, 'group','D','PAR','TUR','2026-06-19T19:00:00+03:00','Estadio Azteca'),
  (23, 'group','D','USA','TUR','2026-06-22T19:00:00+03:00','Rose Bowl'),
  (24, 'group','D','PAR','AUS','2026-06-23T16:00:00+03:00','Mercedes-Benz Stadium'),
  -- Group E
  (25, 'group','E','GER','CUW','2026-06-15T22:00:00+03:00','Estadio Azteca'),
  (26, 'group','E','CIV','ECU','2026-06-16T22:00:00+03:00','MetLife Stadium'),
  (27, 'group','E','GER','CIV','2026-06-19T22:00:00+03:00','BC Place'),
  (28, 'group','E','CUW','ECU','2026-06-20T22:00:00+03:00','Estadio Azteca'),
  (29, 'group','E','GER','ECU','2026-06-23T19:00:00+03:00','Rose Bowl'),
  (30, 'group','E','CUW','CIV','2026-06-24T16:00:00+03:00','Mercedes-Benz Stadium'),
  -- Group F
  (31, 'group','F','NED','JPN','2026-06-16T22:00:00+03:00','Estadio Azteca'),
  (32, 'group','F','TUN','SWE','2026-06-17T19:00:00+03:00','MetLife Stadium'),
  (33, 'group','F','NED','TUN','2026-06-20T22:00:00+03:00','BC Place'),
  (34, 'group','F','JPN','SWE','2026-06-21T19:00:00+03:00','Estadio Azteca'),
  (35, 'group','F','NED','SWE','2026-06-24T19:00:00+03:00','Rose Bowl'),
  (36, 'group','F','JPN','TUN','2026-06-25T16:00:00+03:00','Mercedes-Benz Stadium'),
  -- Group G
  (37, 'group','G','BEL','EGY','2026-06-17T22:00:00+03:00','Estadio Azteca'),
  (38, 'group','G','IRN','NZL','2026-06-18T19:00:00+03:00','MetLife Stadium'),
  (39, 'group','G','BEL','IRN','2026-06-21T22:00:00+03:00','BC Place'),
  (40, 'group','G','EGY','NZL','2026-06-22T19:00:00+03:00','Estadio Azteca'),
  (41, 'group','G','BEL','NZL','2026-06-25T19:00:00+03:00','Rose Bowl'),
  (42, 'group','G','EGY','IRN','2026-06-26T16:00:00+03:00','Mercedes-Benz Stadium'),
  -- Group H
  (43, 'group','H','ESP','CPV','2026-06-18T22:00:00+03:00','Estadio Azteca'),
  (44, 'group','H','KSA','URU','2026-06-19T22:00:00+03:00','MetLife Stadium'),
  (45, 'group','H','ESP','KSA','2026-06-22T22:00:00+03:00','BC Place'),
  (46, 'group','H','CPV','URU','2026-06-23T19:00:00+03:00','Estadio Azteca'),
  (47, 'group','H','ESP','URU','2026-06-26T19:00:00+03:00','Rose Bowl'),
  (48, 'group','H','CPV','KSA','2026-06-27T16:00:00+03:00','Mercedes-Benz Stadium'),
  -- Group I
  (49, 'group','I','FRA','SEN','2026-06-19T22:00:00+03:00','Estadio Azteca'),
  (50, 'group','I','IRQ','NOR','2026-06-20T22:00:00+03:00','MetLife Stadium'),
  (51, 'group','I','FRA','IRQ','2026-06-23T22:00:00+03:00','BC Place'),
  (52, 'group','I','SEN','NOR','2026-06-24T19:00:00+03:00','Estadio Azteca'),
  (53, 'group','I','FRA','NOR','2026-06-27T19:00:00+03:00','Rose Bowl'),
  (54, 'group','I','SEN','IRQ','2026-06-28T16:00:00+03:00','Mercedes-Benz Stadium'),
  -- Group J
  (55, 'group','J','ARG','ALG','2026-06-20T22:00:00+03:00','Estadio Azteca'),
  (56, 'group','J','AUT','JOR','2026-06-21T22:00:00+03:00','MetLife Stadium'),
  (57, 'group','J','ARG','AUT','2026-06-24T22:00:00+03:00','BC Place'),
  (58, 'group','J','ALG','JOR','2026-06-25T19:00:00+03:00','Estadio Azteca'),
  (59, 'group','J','ARG','JOR','2026-06-28T19:00:00+03:00','Rose Bowl'),
  (60, 'group','J','ALG','AUT','2026-06-29T16:00:00+03:00','Mercedes-Benz Stadium'),
  -- Group K
  (61, 'group','K','POR','COL','2026-06-21T22:00:00+03:00','Estadio Azteca'),
  (62, 'group','K','UZB','COD','2026-06-22T22:00:00+03:00','MetLife Stadium'),
  (63, 'group','K','POR','UZB','2026-06-25T22:00:00+03:00','BC Place'),
  (64, 'group','K','COL','COD','2026-06-26T19:00:00+03:00','Estadio Azteca'),
  (65, 'group','K','POR','COD','2026-06-29T19:00:00+03:00','Rose Bowl'),
  (66, 'group','K','COL','UZB','2026-06-30T16:00:00+03:00','Mercedes-Benz Stadium'),
  -- Group L
  (67, 'group','L','ENG','CRO','2026-06-22T22:00:00+03:00','Estadio Azteca'),
  (68, 'group','L','GHA','PAN','2026-06-23T22:00:00+03:00','MetLife Stadium'),
  (69, 'group','L','ENG','GHA','2026-06-26T22:00:00+03:00','BC Place'),
  (70, 'group','L','CRO','PAN','2026-06-27T19:00:00+03:00','Estadio Azteca'),
  (71, 'group','L','ENG','PAN','2026-06-30T19:00:00+03:00','Rose Bowl'),
  ...
  (79, 'round_of_16','','COL','JPN','2026-07-07T17:00:00+03:00','Levis Stadium'),
...
) AS m(mn, stage, grp, ta, tb, ko, venue)
WHERE NOT EXISTS (SELECT 1 FROM matches WHERE match_number = m.mn);
